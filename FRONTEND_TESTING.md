[✔]: images/checkbox-small-blue.png
...
🔗 [**Read More: Component vs (UI) Integration vs E2E tests**](/FRONTEND_TESTING_SECTIONS/testing-strategy/component-vs-integration-vs-e2e-testing.md)
...
🔗 [**Read More: In the beginning, avoid perfectionism**](/FRONTEND_TESTING_SECTIONS/testing-strategy/avoid-perfectionism.md)
...
🔗 [**Read More: Choose a reference browser**](/FRONTEND_TESTING_SECTIONS/testing-strategy/choose-a-reference-browser.md)
...
🔗 [**Read More: Found a bug? Write the test, then fix it**](/FRONTEND_TESTING_SECTIONS/testing-strategy/write-test-then-fix-bug.md)
...
🔗 [**Read More: Await, don't sleep**](/FRONTEND_TESTING_SECTIONS/generic-best-practices/await-dont-sleep.md)
...
wisely**](/FRONTEND_TESTING_SECTIONS/generic-best-practices/name-test-files-wisely.md)
...
🔗 [**Read More: UI Tests Debugging Best Practices**](/FRONTEND_TESTING_SECTIONS/generic-best-practices/ui-tests-debugging-best-practices.md)
...
🔗 [**Read More: Reaching UI state**](./FRONTEND_TESTING_SECTIONS/generic-best-practices/reaching-ui-state.md)
...
🔗 [**Read More: Use your testing tool as your primary development tool**](/FRONTEND_TESTING_SECTIONS/generic-best-practices/use-your-testing-tool-as-your-primary-development-tool.md)
...
🔗 [**Read More: Test the request and response payloads**](/FRONTEND_TESTING_SECTIONS/server-communication-testing/test-request-and-response-payload.md)
...
🔗 [**Read More: Monitoring tests**](/FRONTEND_TESTING_SECTIONS/server-communication-testing/monitoring-tests.md)
...
🔗 [**Read More: Approach the testing pyramid from the top!**](/FRONTEND_TESTING_SECTIONS/beginners/top-to-bottom-approach.md)
...
🔗 [**Read More: Software tests as a documentation tool**](/FRONTEND_TESTING_SECTIONS/testing-perks/tests-as-documentation.md)
...
🔗 [**Read More: Some UI testing problems and the Cypress way**](/FRONTEND_TESTING_SECTIONS/tools/ui-testing-problems-cypress.md)
...
🔗 [**Read More: Visual Regression Testing**](/FRONTEND_TESTING_SECTIONS/tools/visual-regression-testing.md)
...
🔗 [**Read More: Testing a component with Cypress and Storybook**](/FRONTEND_TESTING_SECTIONS/tools/cypress-and-storybook.md)
...
🔗 [**Read More: Cypress + Storybook. Keeping test scenario, data and component rendering in one place.**](/FRONTEND_TESTING_SECTIONS/tools/cypress-and-storybook-exposing-component-from-story.md)
...
🔗 [**Read More: Unit Testing React components with Cypress.**](/FRONTEND_TESTING_SECTIONS/tools/cypress-react-component-test.md)
<br/> <br/>
...
🔗 [**Read More: Test States**](./FRONTEND_TESTING_SECTIONS/advanced/test-states.md)
...
🔗 [**Read More: Test Flake**](./FRONTEND_TESTING_SECTIONS/advanced/test-flake.md)
...
🔗 [**Read More: Combinatorial Testing**](./FRONTEND_TESTING_SECTIONS/advanced/combinatorial-testing.md)
...
🔗 [**Read More: Performance Testing**](./FRONTEND_TESTING_SECTIONS/advanced/performance-testing.md)
...
🔗 [**Read More: Email Testing**](./FRONTEND_TESTING_SECTIONS/advanced/email-testing.md)

<br/><br/>

# `9. Real Life Examples`

## ![✔] 9.1 Siemens - Test the front-end with the integration tests, the back-end with the E2E ones - in reference to [Component vs Integration vs E2e Testing](./FRONTEND_TESTING_SECTIONS/testing-strategy/component-vs-integration-vs-e2e-testing.md)
...
🔗 [**Read More: Test the front-end with the integration tests, the back-end with the E2E ones**](./FRONTEND_TESTING_SECTIONS/real-life-examples/test-front-end-with-integration-back-end-with-e2e.md)
